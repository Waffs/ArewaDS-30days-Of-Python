...
my_brothers = ('Walid','Amir')
my_sisters = ('Zara','Amina','Aisha')
...
fruits = ('Banana','Grapes','Papaya')
vegetables = ('Cabbage','Cucumber')
animal_products = ('Honey','Eggs','Meat')
...
food_stuff_tp[int(len(food_stuff_tp)/2)-1:int(len(food_stuff_tp)/2)+1] # ('Cabbage','Cucumber')
