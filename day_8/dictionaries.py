...
student = dict()
student.update({'first_name': 'Ahmad', 'last_name': 'Saad','gender': 'male','age': 27,'marital_status': 'single','skills':['MySQL','PowerBI','Python'], 'country':'Nigeria','city': 'Kaduna','address': 'unguwan_sarki'})
